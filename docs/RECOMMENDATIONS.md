...
- Metric Truth entries and usage decisions from `docs/METRICS.md` and the
  runtime metric registry;
- source trust tiers, aggregation rules, sample-size thresholds and period
  comparison semantics from `docs/METRICS.md`;
- accepted CS2 domain boundaries from `docs/CS2_DOMAIN_CONTRACT.md`;
