...
- Current active WP: none; latest completed governance WP is `WP-017W Task Type Profiles and Prompt Contract`.
- Next product WP after WP-017W: `WP-017K Real Data Onboarding Promotion to v0.9`.
...
After WP-017W is reviewed and committed by the user if accepted, continue to `WP-017K Real Data Onboarding Promotion to v0.9` only with explicit user/ChatGPT approval. WP-017K must verify registry prerequisites, carry forward WP-017G/H warnings and WP-017J limitation text, and decide promote/block without raising cap or changing product logic.
