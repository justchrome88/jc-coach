...
- `docs/project_management/AGENT_WORKFLOW.md` - Warm repo-native WP role workflow, invocation modes, output modes, task type profiles, Task Card prompt contract and Documentation Steward / Docs Currency Agent checks; not per-task Hot context.
...
- `docs/project_management/AGENT_WORKFLOW.md` - Warm governance/process doc for PM, Implementation, QA and Documentation Steward roles, invocation modes, output modes, task type profiles and standard prompt/report contracts inside WP lifecycle.
