...
| `v0.9` | Real Data Onboarding / Bulk Demo Usage | `WP-017A`-`WP-017H` | in progress; WP-017A diagnosed, WP-017B planned, WP-017C completed no-new, WP-017C2 completed one-demo import/evaluation with batch-cap warning, WP-017D accepted with repair required, WP-017E repaired the auto-evaluation trigger, WP-017F proved it live on pending `#73` | Onboard more real matches/demos through controlled one-demo batches with storage, DB, parser, recommendation and runtime evidence. WP-017F kept cap `1`, imported playable exact-date match `#76`, automatically created recommendation evaluation `#78`, and cleared pending `#73`; WP-017G must review data integrity and metadata limitations before promotion or any cap raise. | `PM_ORCHESTRATOR`, `IMPORT_GUARDIAN`, `DB_GUARDIAN`, `RUNTIME_GUARDIAN`, `TEST_GUARDIAN`, `METRICS_GUARDIAN` |
