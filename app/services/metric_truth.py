...
METRIC_REGISTRY: dict[str, MetricDefinition] = {
    ...
    "early_deaths": MetricDefinition(
        ...
        "Deaths early in the round; currently may be absent and historically fell back to entry_deaths.",
        "approximate",
        ("Do not treat fallback-to-entry-deaths as precise early-round timing.",),
        _usage(diagnosis="warn", recommendation="warn", ai="warn"),
