...
- CANONICAL_SEQUENCE: `R02A4R accepted → R02A4T timed evidence closure → R03 accepted → R04 production deployment accepted → R05 manual beta released → R06 planned → R07 deferred/planned`
...
| H01B-R04 | complete_with_warnings | production deployment and manual beta release; accepted R03 | `/opt/jc-coach-pm/reports/H01B-R04_production_deployment_and_manual_beta_release_report.md` |
| H01B-R05 | released_manual_user_led | accepted R04; begins with user login and manual activation | none |
