...
Canonical role cards live under `project_control/agents/roles/`. This file remains the
...
Role card: `project_control/agents/roles/PM_ORCHESTRATOR.md`.
...
Role card: `project_control/agents/roles/IMPLEMENTATION_AGENT.md`.
...
Role card: `project_control/agents/roles/QA_REVIEWER.md`.
...
Role card: `project_control/agents/roles/DOCUMENTATION_STEWARD.md`.
...
| Tier 1 workflow/control policy | `project_control/agents/AGENT_WORKFLOW.md`, `project_control/agents/PROJECT_OPERATING_PROTOCOL.md`, `project_control/planning/WP_REGISTRY.md`, `project_control/status/CURRENT_STATUS.md`, `project_control/status/HANDOFF.md`, `project_docs/architecture/DECISIONS.md` | Change only by explicit governance/control-plane task or required WP status/report closure update. |
| Tier 2 role and guardian behavior | `project_control/agents/roles/*`, `project_control/agents/guardians/*_GUARDIAN.md`, `project_control/agents/README.md` | Change only by explicit governance/control-plane task for role/guardian behavior. |
| Tier 3 navigation/control maps | `project_control/manifests/DOCS_MAP.md`, `project_control/checklists/MASTER_WP_CHECKLIST.md` | Change only when navigation, context level or WP campaign/control mapping changes. |
