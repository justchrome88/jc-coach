> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/DECISIONS.md`. The original is preserved byte-identically; this copy updates canonical paths only.
...
- 2026-07-05: Per-task Hot context is `AGENTS.md`, `project_control/status/CURRENT_STATUS.md` and `project_control/planning/WP_REGISTRY.md`.
- 2026-07-05: New-session Hot context additionally includes `project_control/status/HANDOFF.md`.
...
- 2026-07-05: `project_control/agents/PROJECT_OPERATING_PROTOCOL.md` is the Warm governance protocol, and `project_control/checklists/MASTER_WP_CHECKLIST.md` is the Warm/Cold human WP campaign map; neither is per-task Hot context.
- 2026-07-05: `project_control/agents/AGENT_WORKFLOW.md` defines repo-native WP roles and Documentation Steward checks; it is not a runtime agent platform and is not per-task Hot context.
- 2026-07-05: Future prompts should use the Task Card and task type profiles in `project_control/agents/AGENT_WORKFLOW.md` instead of repeating generic workflow instructions.
- 2026-07-06: Agent behavior is controlled through
  `project_control/agents/AGENT_WORKFLOW.md` plus Warm role cards under
  `project_control/agents/roles/`; new roles require explicit user approval and
  a role card, with no runtime automation implied.
...
- 2026-07-09: User authorizes
  ...
  changes it.
- 2026-07-05: `_legacy_archive/r02a2-2026-07-11/docs/audit/WP_018_DOCUMENTATION_GOVERNANCE_AUDIT_REPORT.md` is out-of-band governance audit evidence and does not consume the planned WP-018 product block.
