> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/STEAM_IMPORT_ARCHITECTURE.md`. The original is preserved byte-identically; this copy updates canonical paths only.

> СТАТУС: ВСПОМОГАТЕЛЬНЫЙ / ЧАСТИЧНО АКТУАЛЬНЫЙ / НЕ SOURCE OF TRUTH
> Канонические источники: `project_control/status/CURRENT_STATUS.md` и
> `project_docs/operations/STEAM_IMPORT.md`.
