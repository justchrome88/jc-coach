> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/STEAM_IMPORT.md`. The original is preserved byte-identically; this copy updates canonical paths only.
...
- `_legacy_archive/r02a2-2026-07-11/docs/STEAM_MATCH_DATES_RU.md` (historical evidence)
