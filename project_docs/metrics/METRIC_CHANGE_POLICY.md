> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/metrics/METRIC_CHANGE_POLICY.md`. The original is preserved byte-identically; this copy updates canonical paths only.
