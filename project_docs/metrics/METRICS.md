> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/METRICS.md`. The original is preserved byte-identically; this copy updates canonical paths only.
...
> machine registries live in `app/contracts/metrics/`.
