> R02A2 canonical source: `_legacy_archive/r02a2-2026-07-11/docs/metrics/coach/COACH_DOMAIN_METRIC_REQUIREMENTS.md`. The original is preserved byte-identically; this copy updates canonical paths only.
...
in `app/contracts/coach/coach-domain-model.json`.
